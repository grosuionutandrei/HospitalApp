...
export function EditButton({id,name}:EditId) {
    const patient:Patients = {id:id,name:name};
    const[patients,setEditPatient] = useAtom(EditPatientAtom);

    return (
        <button onClick={()=>{setEditPatient(patient)
        }} className="btn btn-outline interest">
